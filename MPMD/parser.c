...
void populatesyncset()
{
    ...
    Fnode* n;
    int i=0,j=0;
    ss=(Fhead*)malloc(TOT_RULES*sizeof(Fhead));
...
tree* parseInputSourceCode(tokenInfo *ti,int* correctParseTree,int id)
{
	//printf("gfgfgfg\n");
	tree *t = createParseTree(id);
